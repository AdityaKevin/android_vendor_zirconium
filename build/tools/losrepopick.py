...
if __name__ == '__main__':
    ...
    for item in mergables:
        ...
        zirconium_project_name = 'platform/' + remove_prefix(item['project'], 'android_').replace('_','/')
        ...
        elif zirconium_project_name in project_name_to_data:
            print('\nAOSP Project found: {0}, resolving as {1}\n'.format(item['project'], zirconium_project_name))
            project_path = remove_prefix(zirconium_project_name, 'platform/')
        elif args.path:
