...
custom_dependencies = "aoszp.dependencies"
org_manifest = "zirconium-devices"  # leave empty if org is provided in manifest
org_display = "Zirconium-Devices"  # needed for displaying
